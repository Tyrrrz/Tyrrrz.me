...
export const publishDonationStats = async () => {
  ...
  const first = top[0]
    ? `<text x="220" y="55" font-family="'Segoe UI', Arial, sans-serif" font-size="24" font-weight="800" fill="#F5C542" text-anchor="middle" letter-spacing="1">&#x2B50; ${esclsx(top[0].name!)}</text>` +
  ...
  const second = top[1]
    ? `<text x="110" y="104" font-family="'Segoe UI', Arial, sans-serif" font-size="22" font-weight="600" fill="#ffffff" text-anchor="middle">&#x1F948; ${esclsx(top[1].name!)}</text>` +
  ...
  const third = top[2]
    ? `<text x="330" y="104" font-family="'Segoe UI', Arial, sans-serif" font-size="22" font-weight="600" fill="#ffffff" text-anchor="middle">${esclsx(top[2].name!)} &#x1F949;</text>` +
  ...
  const fourth = top[3]
    ? `<text x="110" y="155" font-family="'Segoe UI', Arial, sans-serif" font-size="18" font-weight="500" fill="#d1d5db" text-anchor="middle">&#x1F49B; ${esclsx(top[3].name!)}</text>` +
  ...
  const fifth = top[4]
    ? `<text x="330" y="155" font-family="'Segoe UI', Arial, sans-serif" font-size="18" font-weight="500" fill="#d1d5db" text-anchor="middle">${esclsx(top[4].name!)} &#x1F49B;</text>` +
